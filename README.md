...
`落地页 → 学院 → 专业 → 课程 → 建立实践项目 → 5 轮免费试听 → 注册认领会话 → 测试订单 → 课程对话 → 期末考试 → 学分/GPA → 薄弱知识点重修 → 下一节推荐`

当前学院地图包含 17 个学院、95 个专业和 4,192 门完整培养课程。每个专业的大学通识、学院基础、专业核心、方向选修、实践与毕业五个模块都落实到逐门课程，课程学分合计精确等于毕业要求。每个专业与每门课程都说明它在真实工作、生产实践和创业中的用途、可交付成果与方法边界；登录用户可以保存自己的实践项目，后续课程会围绕同一真实问题积累成果。目录参考清华大学、北京大学与斯坦福大学的官方院系和本科专业体系。课程以任务加入个人学籍；星图学籍卡支持测试储值，但会员等级只按已购买并完成的课程金额激活。
